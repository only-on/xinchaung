<template>
  ...
  <div style="margin-bottom: 24px;">
    <a-input-search style="width:364px" enter-button  v-model:value="docOrMp4Drawer.name" placeholder="请输入搜索关键词" @search="searchDocOrMp4List" @keyup.enter="searchDocOrMp4List()" />
  </div>
