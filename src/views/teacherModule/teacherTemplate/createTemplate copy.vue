<template>
  <div class="wrapper">
    <div class="toolbar" v-if="type !== 'view'">
          ...
          <a-form-item>
            ...
            >
              <template #item="{ element, index }">
                ...
                >
                  <template #toolbar v-if="type !== 'view'">
                    <div class="actions">
                      {{ element.id }}
                      <i class="actions-drag iconfont icon-tianjia"></i>
                      <i
