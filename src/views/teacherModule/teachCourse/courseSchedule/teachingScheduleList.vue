        ...
        <div class="table-content">
          <div class="table-time-col">
            ...
            >
              ...
              <div
                v-if="roleName() === 'admin'"
                class="table-time-operate flex-center"
              >
                <span class="time-edit" @click="openSettingTimeModal(index)"
                  >编辑</span
                >
                <span
                  class="time-delete"
          ...
          <a-row type="flex" class="table-body">
            ...
            >
              ...
              >
                <!-- 新增时间段 -->
                <div
                  v-if="classVal.NoData"
                  class="course-no-data flex-center"
                ></div>
                <!-- 过期 -->
                <div
                ...
                >
                  <div class="flex-center top">
                    <div class="number">
                      当前上课人数{{ classVal.total_students }}
                    </div>
                  </div>
                  <div class="flex-center bottom">
                    <div class="number">
                      自由学习人数{{ classVal.free_onlinenum }}
                    </div>
                  </div>
                </div>
                <!-- 有当前教师 -->
                ...
                >
                  <div class="edit-wrap flex-center">
                    ...
                    <div
                      ...
                      @click="
                        cancelScheduleConfirm(classVal.arrangements[0].cid)
                      "
                    >
                      删除预约
                    </div>
                ...
                >
                  ...
                  <div class="course-info flex-center">
                    ...
                    <div class="course-info-reserved">
                      <a-popover
                        v-if="
                          classVal.arrangements && classVal.arrangements.length
                        "
                      >
...
export default defineComponent({
  ...
  setup() {
    ...
    function compareTime(
      ...
      const currentTimeYMD =
        mapperWeekDate.value[weekIndex].format("YYYY-MM-DD");
        ...
        .table-td {
          ...
          .course-overdue {
            ...
            .overdue {
              width: 72px;
              height: 72px;
              background: url("src/assets/images/teacherSchedule/overdue.png")
                no-repeat;
    ...
    .table-time-col {
      ...
      .table-time-list {
        ...
        .table-time-operate {
          ...
          color: var(--primary-color);
          & > i:hover {
            color: rgba(var(--primary-color), 0.15);
          }
          .time-delete {
            padding: 10px 0;
          }
