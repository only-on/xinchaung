      ...
      <div class="create-form">
        ...
        <div class="file-upload">
          ...
          <div class="md-upload-box">
            ...
            <span></span>
            <div>
              <a-upload :before-upload="MdFileBeforeReader" :show-upload-list="false" accept=".md">
                <a-button>
                  <span class="icon iconfont icon-upload"></span>
                  上传说明
                </a-button>
  ...
  setup() {
    ...
    function beforeUpload(file:any){
      ...
      http.upLoadCover({param:fd}).then((res:any)=>{
        ...
        state.ForumSearch.cover=data.path,
    ...
    function processFun(e: any, v: any, length: number) {
      ...
      state.ForumSearch.fileList[v.fileMd5].progress =Number((progress / length).toFixed(2)) !== 100 ? Number((progress / length).toFixed(2)) : 99
    }
    ...
    function  collectForm() {
      ...
      for (const key in state.ForumSearch.fileList) {
        if (Object.prototype.hasOwnProperty.call(state.ForumSearch.fileList, key)) {
...
.upload-drawer-detail {
    ...
    .ant-drawer-wrapper-body {
        ...
        .ant-drawer-body {
            //火狐
            scrollbar-color: rgba(var(--primary-color), .8) rgba(var(--primary-color), .2);
