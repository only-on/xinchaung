  ...
  <div class="create-wrap" v-layout-bg>
      ...
      <a-form ref="formRef" :model="formState" layout="vertical" :rules="rules">
        <div class="base-info">
          ...
          <a-form-item label="课时数" name="class_cnt">
            <a-input
              v-model:value="formState.class_cnt"
              placeholder="请输入课时数"
            />
          </a-form-item>
        </div>
        ...
        <a-form-item label="数据集" name="selectedName">
          ...
          <div class="data-list-box">
            <div
              class="data-item"
              v-for="(item, index) in formState.selectedName"
              :key="item.uid"
            >
              <span class="data-name">{{ item.name }}</span>
              <span class="wenjian iconfont icon-wenjian"
                >&nbsp;{{ item.amount }}个</span
              >
              <span class="cunchuzhi iconfont icon-cunchuzhi"
                >&nbsp;{{ item.size }}</span
              >
              <span
                class="shanchu iconfont icon-shanchu"
                @click="removeDataSet(item, index)"
              ></span>
            </div>
          </div>
        </a-form-item>
        ...
        <a-form-item label="实验任务" v-if="type === 'note'" name="taskData">
          <task-list
            v-model:taskData="formState.taskData"
            :jupyterUuid="jupyterUuid"
          ></task-list>
        </a-form-item>
        <a-form-item class="footer-btn">
          <a-button @click="cancel">取消</a-button>
          <a-button class="create-btn" type="primary" @click="submit"
            >创建</a-button
          >
        </a-form-item>
      </a-form>
    ...
    >
      ...
      <div class="image" v-if="selectType === 'image'">
        <environment
          v-model="formState.imageDataSelected"
