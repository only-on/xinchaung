  ...
  <div id="statistic" class="setScrollbar">
    <div class="box-left">
      <div class="left-f1 f1">
        <p class="hint">
          {{ staticInfo.userProfile?.name }}，又是元气满满的一天！
        </p>
      ...
      <div class="left-f3 f3">
        <div class="left-f3-course">
          <list-item
            :infoList="staticInfo.weakKnowledges"
            :title="'课程薄弱点'"
        ...
        <div class="left-f3-exper">
          <list-item
            :infoList="staticInfo?.weakCourseContents"
            :title="'推荐实验'"
            :listname="'name'"
            :color1="lineOrange"
    ...
    <div class="box-right">
          ...
          <div class="proess-con-left">
            <div class="stu-state-row">
              ...
              <div class="study-right">
                ...
                <div class="courseProgress">
                  <span>NO.</span
                  ><span>{{ staticInfo.courseProgress?.id }}</span>
                </div>
              </div>
            </div>
            <div class="stu-state-row">
              ...
              <div class="study-right">
                ...
                <div class="progressdiv">
                  <span class="courseProgress">{{
                    staticInfo.courseProgress?.finished_content_count
                  }}</span
            ...
            <div class="stu-state-row">
              ...
              <div class="study-right">
                ...
                <div class="progressdiv">
                  <span class="courseProgress">{{
                    staticInfo.courseProgress?.left_content_count
                  }}</span
                  ><span class="unit">/ 个</span>
                </div>
              </div>
      ...
      <div class="right-f3 f3">
        ...
        <list-item
          :infoList="staticInfo.jobDirections"
          :title="'发展方向'"
          :listname="'name'"
          :color1="lineBlue"
          :circlecolor="circlecolor3"
        ></list-item>
      </div>
    </div>
  </div>
...
export default defineComponent({
  ...
  setup: (props, { emit }) => {
    ...
    const state: State = reactive({
      staticInfo: {},
      lineBlue:
        "linear-gradient(90deg, rgba(18, 144, 239, 0.12) 24%, rgba(98, 126, 234, 0) 78%)",
      lineOrange:
        "linear-gradient(90deg,rgba(247,147,26,0.12) 24%, rgba(98,126,234,0.00) 78%)",
      linePurple:
        "linear-gradient(90deg,rgba(98,126,234,0.12) 24%, rgba(98,126,234,0.00) 78%)",
      circlecolor1: "#647fea",
      circlecolor2: "#f79620",
      circlecolor3: "#1290ef",
    });
