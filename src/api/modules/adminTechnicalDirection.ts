...
export default {
    ...
    /**方向规划列表接口 */
    technologyList: { url: '/api/plan/category/技术方向/tags', method: "GET", dataType: 'formdata' },//技术
    classList: { url: '/api/plan/category/课程方向/tags', method: "GET", dataType: 'formdata' },//课程
    occupation: { url: ' /api/plan/category/职业方向/tags', method: "GET", dataType: 'formdata' },//职业
    LabelingrulesList: { url: '/api/plan/tags', method: "GET", dataType: 'formdata' },//标签
    /**方向规划标签修改接口*/
