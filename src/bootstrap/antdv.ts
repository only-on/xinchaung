...
export const initAntdv: TFInitApp = function (appManager: IAppManager) {
    appManager.installPlugins(Button, DatePicker, Calendar, Steps, Switch, Radio, Breadcrumb, Menu, Dropdown, Tag, Form, Input, Select, Table, Pagination, Spin, ConfigProvider, Modal, Card, Progress, Tree, Carousel, Checkbox, Image, InputNumber, Tabs, Upload, Col, Row, Divider, Popconfirm, Tooltip, Transfer, Space, TimePicker, Rate)
